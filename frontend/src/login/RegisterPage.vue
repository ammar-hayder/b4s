<template>
    <div>
        <h2>Register new user <a href="/login" class="float-right" >Login</a></h2>
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                <button class="btn btn-primary" :disabled="creating">Create user</button>
...
export default {
    ...
    computed: {
        creating () {
            return this.$store.state.users.status.creating;
        }
    },
    methods: {
        handleSubmit (e) {
            ...
            if (username && password) {
                dispatch('users/newUser', { username, password });
            }
        }
    }
};
